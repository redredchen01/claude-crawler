...
/**
 * Generate PostgreSQL migration from Prisma schema
 * This script creates the initial PostgreSQL schema migration
 */
...
// PostgreSQL schema generation SQL
const migrationSQL = `-- PostgreSQL Schema Migration
...
console.log("✅ PostgreSQL migration generated:");
console.log(`   Directory: ${migrationDir}`);
console.log(`   SQL File: ${migrationSqlPath}`);
console.log("\nNext steps:");
console.log(
  "1. Start PostgreSQL: docker-compose -f docker-compose.dev.yml up -d",
);
console.log(
  "2. Run migration: DATABASE_URL=postgresql://postgres:postgres@localhost:5432/prompt_optimizer npx prisma migrate resolve --applied init_postgresql",
);
console.log("3. Verify schema: npm run test:ci");
